  ...
  const content = (
    <div className={`inline-flex items-center gap-2 select-none group ${className}`}>
      {isIcon ? (
        ...
        <svg
          viewBox="0 0 100 100"
          className={`${iconSizes} w-auto drop-shadow-[0_0_12px_rgba(34,197,94,0.35)] transition-transform group-hover:scale-105`}
          fill="none"
        ...
        <div className="flex flex-col">
          <div className="flex items-center">
            <svg
              viewBox="0 0 320 80"
              className={`${fullSizes} w-auto drop-shadow-[0_0_15px_rgba(20,184,166,0.25)] transition-transform group-hover:scale-[1.02]`}
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              {/* White 'R' */}
          ...
          <span className="text-[11px] font-bold tracking-[0.22em] text-white/90 pl-[70px] -mt-1 uppercase font-mono">
            RatingPulse
          </span>
        </div>
      )}

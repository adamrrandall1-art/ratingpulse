    ...
    <>
      <header className="min-h-16 py-2 bg-white border-b border-slate-200 px-3 sm:px-6 flex items-center justify-between z-20 sticky top-0 gap-2">
        ...
        <div className="flex items-center gap-1.5 sm:gap-4 min-w-0">
          ...
          <div className="flex items-center gap-2 px-2.5 sm:px-3 py-1.5 rounded-xl bg-slate-100/80 border border-slate-200/80 text-xs text-slate-500 transition-all focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500 focus-within:bg-white">
            ...
            <input
              ...
              placeholder="Search..."
              className="bg-transparent border-none text-xs text-slate-800 focus:outline-none w-24 xs:w-36 sm:w-48 md:w-64 placeholder:text-slate-400"
            />
            {searchQuery && (
              <button
                type="button"
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          <div className="flex items-center gap-1 bg-slate-100/90 hover:bg-slate-200/70 p-1 sm:p-1.5 rounded-2xl border border-slate-200 transition-colors">
            <button
              onClick={handleToggleDemoMode}
              className={`flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-1 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                isDemoMode
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold shadow-sm shadow-blue-600/30 transition-all transform active:scale-95 cursor-pointer"
          >

...
export const initialInvites: Invite[] = [
  ...
  },
  {
    ...
    customer_phone: '+1 (555) 392-8819',
    customer_email: 'marcus.h@example.com',
    service_type: 'Root Canal Consultation',
    status: 'feedback_submitted',
    sent_at: new Date(Date.now() - 5 * 3600000).toISOString(),
    review_received_at: new Date(Date.now() - 4 * 3600000).toISOString(),
    rating_received: 2,
    feedback_text: 'The wait time in the reception area was over 30 minutes past my appointment time. The dentist was skilled, but the delay was frustrating because I had to get back to work.',
  ...
  },
  {
    ...
    customer_phone: '+1 (555) 621-9944',
    customer_email: 'elena.rostova@example.com',
    service_type: 'Orthodontic Adjustment',
    status: 'feedback_submitted',
    sent_at: new Date(Date.now() - 14 * 3600000).toISOString(),
    review_received_at: new Date(Date.now() - 13 * 3600000).toISOString(),
    rating_received: 3,
    feedback_text: 'Front desk staff seemed distracted and did not explain the insurance co-pay breakdown clearly before the procedure.',
